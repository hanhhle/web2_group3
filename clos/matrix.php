...
<h2>CLO - PLO Mapping Matrix</h2>
<p class="text-muted">Enter the percentage contribution of each Course Learning Outcome (CLO) to the Program Learning Outcome (PLO).</p>
        ...
        <form action="matrix.php" method="GET" class="row g-3">
            <div class="col-md-5">
                <select name="program_id" class="form-select" onchange="this.form.submit()" required>
                    <option value="">-- Step 1: Select Program --</option>
            ...
            <div class="col-md-5">
                <select name="subject_id" class="form-select" onchange="this.form.submit()" required>
                    <option value="">-- Step 2: Select Subject --</option>
...
<?php if ($selected_program_id && $selected_subject_id): ?>
    <?php if (empty($plos) || empty($clos)): ?>
        <div class="alert alert-warning">Please ensure this subject has CLOs and this program has PLOs.</div>
    <?php else: ?>
        <form action="save_matrix.php" method="POST">
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-success px-5 fw-bold">💾 Save Mapping Matrix</button>
            </div>
        </form>
    <?php endif; ?>
<?php endif; ?>
