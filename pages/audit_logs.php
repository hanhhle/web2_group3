...
function pageAUDIT_LOGS(): void {
    ...
    if ($isAdmin) {
        ...
        $pageDesc  = 'Full activity trail — all users, all actions';
    } else {
        $logs = qAll(
            "SELECT al.*, u.username, u.full_name
             FROM audit_logs al
        ...
        $pageDesc  = 'Your grading and verification history';
    }
    ...
    foreach ($logs as $l) {
        ...
        echo "<tr>
            ...
            <td class='log-mono record'>{$recordId}</td>
